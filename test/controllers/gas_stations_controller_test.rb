...
class GasStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gas_station" do
    assert_difference('GasStation.count') do
      post gas_stations_url, params: { gas_station: { address: @gas_station.address, id_station: @gas_station.id_station, image: @gas_station.image, name: @gas_station.name } }
    end
  ...
  test "should update gas_station" do
    patch gas_station_url(@gas_station), params: { gas_station: { address: @gas_station.address, id_station: @gas_station.id_station, image: @gas_station.image, name: @gas_station.name } }
